...
/**
 * XMilvus功能中Insert语句的具体操作与实现。
 * 
 * 核心区别：它与executeUpdate方法的核心区别是：本类的所有方法将尝试返回【数据库级的自增ID】，方法返回类型为：MilvusData
...
public class XMilvusOPInsert
{
     ...
     */
    public static MilvusData executeInsert(final XMilvus i_XMilvus)
    {
        i_XMilvus.checkContent();
        
        boolean             v_IsError       = false;
        String              v_ErrorInfo     = null;
        Map<String ,Object> v_TriggerParams = i_XMilvus.executeBeforeForTrigger("executeInsert" ,(Object) null);
        ...
        try
        {
            ...
            MilvusData v_MilvusData = XMilvusOPInsert.executeInsert_Inner(i_XMilvus ,v_Content ,i_XMilvus.getMilvus());
            v_IORowCount = v_MilvusData.getRowCount();
            return v_MilvusData;
        }
     ...
     * @return           返回语句影响的记录数及自增长ID
     */
    public static MilvusData executeInsert(final XMilvus i_XMilvus ,final Map<String ,?> i_Values)
    {
        i_XMilvus.checkContent();
        
        boolean             v_IsError       = false;
        String              v_ErrorInfo     = null;
        Map<String ,Object> v_TriggerParams = i_XMilvus.executeBeforeForTrigger("executeInsert" ,i_Values);
        long                v_IORowCount    = 0L;
        String              v_Content       = null;
        ...
        try
        {
            ...
            MilvusData v_Ret = XMilvusOPInsert.executeInsert_Inner(i_XMilvus ,v_Content ,i_XMilvus.getMilvus());
     ...
     * @return           返回语句影响的记录数及自增长ID
     */
    public static MilvusData executeInsert(final XMilvus i_XMilvus ,final Object i_Values)
    {
        i_XMilvus.checkContent();
     ...
     * @return           返回语句影响的记录数及自增长ID
     */
    public static MilvusData executeInsert(final XMilvus i_XMilvus ,final String i_Content)
    {
        boolean             v_IsError       = false;
        String              v_ErrorInfo     = null;
        Map<String ,Object> v_TriggerParams = i_XMilvus.executeBeforeForTrigger("executeInsert" ,(Object) null);
        ...
        try
        {
            MilvusData v_Ret = XMilvusOPInsert.executeInsert_Inner(i_XMilvus ,i_Content ,i_XMilvus.getMilvus());
            v_IORowCount = v_Ret.getRowCount();
            return v_Ret;
        }
        // RuntimeException 是 NullPointerException 的父类，不用专门再写一个 NullPointerException 类型的catch
     ...
     * @return           返回语句影响的记录数及自增长ID。
     */
    private static MilvusData executeInsert_Inner(final XMilvus i_XMilvus ,final String i_Content ,final MilvusHelp i_Milvus)
    {
        ...
        try
        {
            ...
            {
                v_Identitys = i_Milvus.insert(i_XMilvus.getCollection() ,i_XMilvus.getPartition() ,i_Content);
            }
            else 
            {
                v_Identitys = i_Milvus.inserts(i_XMilvus.getCollection() ,i_XMilvus.getPartition() ,i_Content);
            }
     ...
     * @return           返回语句影响的记录数及自增长ID。
     */
    public static MilvusData executeInsert(final XMilvus i_XMilvus ,final MilvusHelp i_Milvus)
    {
        i_XMilvus.checkContent();
        ...
        {
            v_Content = i_XMilvus.getContent().getContent();
            MilvusData v_Ret = XMilvusOPInsert.executeInsert_Inner(i_XMilvus ,v_Content ,i_Milvus);
            v_IORowCount = v_Ret.getRowCount();
            return v_Ret;
        }
        // RuntimeException 是 NullPointerException 的父类，不用专门再写一个 NullPointerException 类型的catch
     ...
     * @return           返回语句影响的记录数及自增长ID。
     */
    public static MilvusData executeInsert(final XMilvus i_XMilvus ,final Map<String ,?> i_Values ,final MilvusHelp i_Milvus)
    {
        i_XMilvus.checkContent();
     ...
     * @return           返回语句影响的记录数及自增长ID。
     */
    public static MilvusData executeInsert(final XMilvus i_XMilvus ,final Object i_Values ,final MilvusHelp i_Milvus)
    {
        i_XMilvus.checkContent();
     ...
     * @return           返回语句影响的记录数及自增长ID。
     */
    public static MilvusData executeInsert(final XMilvus i_XMilvus ,final String i_Content ,final MilvusHelp i_Milvus)
    {
        boolean             v_IsError       = false;
        String              v_ErrorInfo     = null;
        Map<String ,Object> v_TriggerParams = i_XMilvus.executeBeforeForTrigger("executeInsert" ,(Object) null);
        ...
        try
        {
            MilvusData v_Ret = XMilvusOPInsert.executeInsert_Inner(i_XMilvus ,i_Content ,i_Milvus);
            v_IORowCount = v_Ret.getRowCount();
            return v_Ret;
        }
        // RuntimeException 是 NullPointerException 的父类，不用专门再写一个 NullPointerException 类型的catch
     ...
     * @return           返回语句影响的记录数。
     */
    public static MilvusData executeInserts(final XMilvus i_XMilvus ,final List<?> i_ObjList)
    {
        i_XMilvus.checkContent();
        
        boolean             v_IsError       = false;
        String              v_ErrorInfo     = null;
        Map<String ,Object> v_TriggerParams = i_XMilvus.executeBeforeForTrigger("executeInserts" ,(Object) null);
        long                v_IORowCount    = 0L;

        try
        {
            i_XMilvus.fireBeforeRule(i_ObjList);
            MilvusData v_Ret = XMilvusOPInsert.executeInserts_Inner(i_XMilvus ,i_ObjList ,i_XMilvus.getMilvus());
            v_IORowCount = v_Ret.getRowCount();
            return v_Ret;
        }
        // RuntimeException 是 NullPointerException 的父类，不用专门再写一个 NullPointerException 类型的catch
     ...
     * @return           返回语句影响的记录数。
     */
    public static MilvusData executeInserts(final XMilvus i_XMilvus ,final List<?> i_ObjList ,final MilvusHelp i_Milvus)
    {
        i_XMilvus.checkContent();
        ...
        {
            i_XMilvus.fireBeforeRule(i_ObjList);
            MilvusData v_Ret = XMilvusOPInsert.executeInserts_Inner(i_XMilvus ,i_ObjList ,i_Milvus);
            v_IORowCount = v_Ret.getRowCount();
            return v_Ret;
        }
        // RuntimeException 是 NullPointerException 的父类，不用专门再写一个 NullPointerException 类型的catch
     ...
     * 批量执行：占位符Content的Insert语句的执行。
     * 
     *   1. 按对象 i_ObjList 填充占位符Content，生成可执行的Content语句；
     * 
     *   注：只支持单一Content语句的执行
     * 
     * @author      ZhengWei(HY)
     ...
     * @return           返回语句影响的记录数。
     */
    private static MilvusData executeInserts_Inner(final XMilvus i_XMilvus ,final List<?> i_ObjList ,final MilvusHelp i_Milvus)
    {
        long          v_Ret       = 0;
        long          v_BeginTime = i_XMilvus.request().getTime();
        String        v_Content   = null;
        ...
        try
        {
            ...
            {
                throw new NullPointerException("Batch execute update List<Object> is null of XMilvus[" + Help.NVL(i_XMilvus.getXJavaID() ,i_XMilvus.getObjectID()) + "].");
            }
            ...
            for (Object v_Obj : i_ObjList)
            {
                ...
                MilvusData v_ChildRet = XMilvusOPInsert.executeInsert_Inner(i_XMilvus ,v_Content ,i_Milvus);
