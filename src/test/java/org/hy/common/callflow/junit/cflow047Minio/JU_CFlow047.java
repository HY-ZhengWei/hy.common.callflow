package org.hy.common.callflow.junit.cflow047Minio;
...
public class JU_CFlow047 extends JUBase
{
    ...
    public JU_CFlow047() throws Exception
    {
        if ( !$isInit )
        {
            $isInit = true;
    ...
    @Test
    public void test_CFlow047()
    {
        this.test_CFlow047_Inner();
    }
    
    
    
    private void test_CFlow047_Inner()
    {
        // 初始化被编排的执行对象方法
        ...
        Return<Object> v_CheckRet = CallFlow.getHelpCheck().check(v_Minio);
        if ( !v_CheckRet.get() )
        {
        ...
        // 导出
        System.out.println(CallFlow.getHelpExport().export(v_Minio));
