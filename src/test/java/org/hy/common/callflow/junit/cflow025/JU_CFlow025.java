package org.hy.common.callflow.junit.cflow025;
...
import org.hy.common.callflow.junit.cflow025.program.Program;
...
public class JU_CFlow025 extends JUBase
{
    ...
    public JU_CFlow025() throws Exception
    {
        if ( !$isInit )
        {
            $isInit = true;
    ...
    private void test_CFlow025_Inner()
    {
        // 初始化被编排的执行对象方法
        XJava.putObject("XProgram" ,new Program());
        
        // 获取编排中的首个元素
        MTConfig            v_MT      = (MTConfig) XJava.getObject("XMT_CF025_开始");
