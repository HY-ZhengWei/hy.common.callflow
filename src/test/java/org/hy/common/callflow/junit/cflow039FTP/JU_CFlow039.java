package org.hy.common.callflow.junit.cflow039FTP;
...
public class JU_CFlow039 extends JUBase
{
    ...
    public JU_CFlow039() throws Exception
    {
        if ( !$isInit )
        {
            $isInit = true;
    ...
    @Test
    public void test_CFlow039()
    {
        this.test_CFlow039_Inner();
    }
    
    
    
    private void test_CFlow039_Inner()
    {
        // 初始化被编排的执行对象方法
        ...
        Return<Object> v_CheckRet = CallFlow.getHelpCheck().check(v_Ftp);
        if ( !v_CheckRet.get() )
        {
        ...
        // 导出
        System.out.println(CallFlow.getHelpExport().export(v_Ftp));
