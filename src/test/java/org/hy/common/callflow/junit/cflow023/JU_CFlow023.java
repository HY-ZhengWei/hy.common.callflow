package org.hy.common.callflow.junit.cflow023;
...
import org.hy.common.callflow.junit.cflow023.program.Program;
...
public class JU_CFlow023 extends JUBase
{
    ...
    public JU_CFlow023() throws Exception
    {
        if ( !$isInit )
        {
            $isInit = true;
    ...
    @Test
    public void test_CFlow023() throws InterruptedException
    {
        test_CFlow023_Inner();
    ...
    private void test_CFlow023_Inner() throws InterruptedException
    {
        ...
        Return<Object> v_CheckRet = CallFlow.getHelpCheck().check(v_Subscribe);
        if ( !v_CheckRet.get() )
        {
        ...
        // 导出
        System.out.println(CallFlow.getHelpExport().export(v_Subscribe));
