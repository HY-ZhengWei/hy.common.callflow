package org.hy.common.callflow.junit.cflow041ThreeInOne;
...
import org.hy.common.callflow.junit.cflow041ThreeInOne.program.Program;
...
public class JU_CFlow041 extends JUBase
{
    ...
    public JU_CFlow041() throws Exception
    {
        if ( !$isInit )
        {
            $isInit = true;
    ...
    @Test
    public void test_CFlow041()
    {
        this.test_CFlow041_Inner();
    }
    
    
    
    private void test_CFlow041_Inner()
    {
        // 初始化被编排的执行对象方法
