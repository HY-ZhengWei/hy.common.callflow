...
public class JU_CFlow040 extends JUBase
{
    ...
    public JU_CFlow040() throws Exception
    {
        if ( !$isInit )
        {
            $isInit = true;
    ...
    @Test
    public void test_CFlow040()
    {
        this.test_CFlow040_Inner();
    }
    
    
    
    private void test_CFlow040_Inner()
    {
        // 初始化被编排的执行对象方法
        XJava.putObject("XProgram" ,new Program());
        
        // 获取编排中的首个元素
        NodeConfig          v_Node    = (NodeConfig) XJava.getObject("XNode_CF040_Start");
