package org.hy.common.callflow.junit.cflow030Nesting;
...
import org.hy.common.callflow.junit.cflow030Nesting.program.Program;
...
public class JU_CFlow030 extends AppInitConfig
{
    ...
    public JU_CFlow030() throws Exception
    {
        if ( !$isInit )
        {
            $isInit = true;
    ...
    private void test_CFlow030_Inner()
    {
        // 初始化被编排的执行对象方法
