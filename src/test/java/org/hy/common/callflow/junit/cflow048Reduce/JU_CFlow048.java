package org.hy.common.callflow.junit.cflow048Reduce;
...
import org.hy.common.callflow.junit.cflow048Reduce.program.Program;
...
public class JU_CFlow048 extends JUBase
{
    ...
    public JU_CFlow048() throws Exception
    {
        if ( !$isInit )
        {
            $isInit = true;
    ...
    @Test
    public void test_CFlow048()
    {
        this.test_CFlow048_Inner();
    }
    
    
    
    private void test_CFlow048_Inner()
    {
        // 初始化被编排的执行对象方法
