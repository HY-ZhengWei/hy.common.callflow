package org.hy.common.callflow.junit.cflow019API;
...
import org.hy.common.callflow.junit.cflow019API.program.Program;
...
public class JU_CFlow019 extends JUBase
{
    ...
    private void test_CFlow019_Inner()
    {
        ...
        // 获取编排中的首个元素
        JavaConfig           v_Java    = (JavaConfig) XJava.getObject("XJava_CF019_定义对象A");
        Map<String ,Object> v_Context = new HashMap<String ,Object>();
        
        v_Context.put("MockSucceed" ,true);
        
        // 执行前的静态检查（关键属性未变时，check方法内部为快速检查）
        Return<Object> v_CheckRet = CallFlow.getHelpCheck().check(v_Java);
        if ( !v_CheckRet.get() )
        {
        ...
        ExecuteResult v_Result = CallFlow.execute(v_Java ,v_Context);
        ...
        System.out.println("返回值：ReturnData=" + v_Context.get("ReturnData"));
        ...
        // 导出
        System.out.println(CallFlow.getHelpExport().export(v_Java));
