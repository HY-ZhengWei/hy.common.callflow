package org.hy.common.callflow.junit.cflow045LoadRunnerAPI;
...
public class JU_CFlow045 extends JUBase
{
    ...
    public JU_CFlow045() throws Exception
    {
        if ( !$isInit )
        {
            $isInit = true;
    ...
    @Test
    public void test_CFlow045()
    {
        this.test_CFlow045_Inner();
    }
    
    
    
    private void test_CFlow045_Inner()
    {
        // 初始化被编排的执行对象方法
        XJava.putObject("XProgram" ,new Program());
        
        // 获取编排中的首个元素
        ForConfig           v_For     = (ForConfig) XJava.getObject("XCFlow_CF045_LoadRunner_For");
        Map<String ,Object> v_Context = new HashMap<String ,Object>();
        
        v_Context.put("LoadRunnerCounter" ,5000);
