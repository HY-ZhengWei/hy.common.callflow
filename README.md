...
------
    ...
    2. 14种高级元素。
        ...
        2.10. API接口元素，衍生于执行元素，用于API接口请求访问。
        
        2.11. ZIP压缩元素，衍生于执行元素，文件、文件流、多个文件或目录压缩成一个压缩包。
        
        2.12. DEC解压元素，衍生于执行元素，压缩包解压。
        
        2.13. ENF密文元素，衍生于执行元素，对文件或文件流的加密存储。密钥可由MD5自动生成。
        
        2.14. DEF解文元素，衍生于执行元素，对加密文件的解密。
